---
layout:     post
title:      "【职场修炼】只实现功能就够了吗？[1]"
subtitle:   "关于一个简单排列组合问题的多种思考"
...
# 引
前段时间在准备招聘事宜的时候看到一道Java笔试题：
> 有1、2、3、4四个数字，能组成多少个互不相同且无重复数字的三位数？都是多少？

这是一个简单的排列组合题，大家都知道这题的答案是24个；不过题面是要求用代码的方式计算出来，并输出这些数字。

别看只是一道简单的Java题，但我感到这是一个考察答题者思维深度和广度的好题。子曾经曰过：==同样是九阴白骨爪，由周芷若和黄衫女使出来，那就是一个地下一个天上！==

解法有几种呢？我们来按武功修为从浅到深的顺序来看一看：
![image](http://ogw4950jb.bkt.clouddn.com/%E6%AD%A6%E5%8A%9F.jpg?imageMogr2/thumbnail/500x)
